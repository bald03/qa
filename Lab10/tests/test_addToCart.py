"""
Тесты для проверки функциональности добавления товаров в корзину.
...
def load_test_data():
    ...
    Returns:
        dict: Словарь с тестовыми данными (URL, названия товаров, цены, ожидаемые сообщения)
    """
...
def test_add_single_product_to_cart_and_verify(driver):
    ...
    # Шаг 1: Открыть страницу продуктов
    ...
    # Шаг 3: Проверить сообщение о добавлении
    ...
    # Шаг 5: Проверить наличие товара в корзине
    ...
    # Проверяем, что цена товара присутствует в корзине
...
def test_add_multiple_products_to_cart(driver):
    ...
    # Шаг 3: Продолжить покупки
    cart_page.continue_shopping()

    # Шаг 4: Добавить второй товар
    ...
    # Шаг 6: Проверить наличие обоих товаров
    cart_item_names = cart_page.get_cart_item_names()
