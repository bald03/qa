"""
Тесты для проверки функциональности авторизации на сайте AutomationExercise.com.
...
# Команда для запуска: pytest tests/test_login.py -v
...
def load_test_data():
    ...
    Returns:
        dict: Словарь с тестовыми данными (URL, учетные данные, ожидаемые сообщения)
    
    Note:
        Используется encoding='utf-8' для корректной работы с кириллицей в комментариях JSON.
    """
